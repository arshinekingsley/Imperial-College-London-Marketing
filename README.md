...
The analysis uses API calls to the FDA MAUDE and FAERs databases to retrieve information on recalls, and product launches in medical devices, and drug related deaths in Pharma of Bayer and its peer group.
